...
<body>
	<div class="box-swiper" id="box-swiper">
		<div class="swiper-container">
			<div class="swiper-wrapper clearfix">
				...
				<a href="<?php echo ($value['url']); ?>" class="swiper-slide">
	...
	<div class="box-user clearfix">
		<a href="/Public/home/login.html"><i class="iconfont">&#xe61a;</i>购物车</a>
		<a href="/Public/home/people.html"><i class="iconfont">&#xe659;</i>我的中心</a>
	</div>
	<div class="box-list">
		...
		<div class="list-cntent clearfix">
			...
			<div>
				<a href="<?php echo U('Home/goods/info',array('id'=>$value['id']));?>">
					<div class="content-img">
						<img src="/Public/<?php echo ($value['image']); ?>" width="50"  alt="">
					</div>
					<div class="content-text">
						<h3><?php echo ($value['title']); ?></h3>
						<p><?php echo ($value['desc']); ?></p>
						<b><?php echo ($value['price']); ?></b><span ><?php echo ($value['tag_id']); ?></span>
					</div>
				</a>
			</div>		
			<?php } ?>			
