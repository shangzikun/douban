                ...
                <div class="ibox-content">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                ...
                                <td><a href="<?php echo U('admin/ad/edit',array('id'=>$vo['id']));?>">编辑</a>
                                    <?php if($vo['status']==0 || $vo['status']==2) { ?>
                                        <a href="<?php echo U('admin/ad/onLine',array('id'=>$vo['id']));?>">上线</a>
                                    <?php } else { ?>  
                                    <a href="<?php echo U('admin/ad/offLine',array('id'=>$vo['id']));?>">下线</a>
                                    <?php } ?></td>
