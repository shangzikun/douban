...
<head>
    ...
    <title>豆瓣市集后台管理</title>

    <meta name="keywords" content="豆瓣后台主题,后台bootstrap框架,会员中心主题,后台HTML,响应式后台">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">豆瓣市集管理</span>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="J_menuItem" href="<?php echo U('Category/lists');?>" data-index="0">标签管理</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo U('home/index/index');?>" data-index="0">豆瓣市集主页</a>
                            </li>
                            <li>
